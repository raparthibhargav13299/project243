...
//                List<NodeTitleDuration> documentForConcept = domainQueryRepository.getAllDocumentsForGivenConcept(concept);
                ...
                List<String> parentVideo = domainQueryRepository.getAllTitlesForVideoOfConcepts(concept, intent);
                ...
                if (innerConcept.isEmpty()) {
                    ...
                    for (String childConcept : innerConcept) {
                        ...
                        List<String> childVideo = domainQueryRepository.getAllTitlesForVideoOfConcepts(childConcept, intent);
